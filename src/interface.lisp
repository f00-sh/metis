...
(defparameter *iface-concepts*
  '(("number" . "A number is a mathematical object used to count, measure, and label. Whole numbers (0, 1, 2, …) count discrete things; integers include negatives; rationals are fractions; reals fill the continuum. Arithmetic (+ − × ÷) is the basic language of numbers.")
    ...
    ("noun" . "A noun names a person, place, thing, or idea — cat, river, Metis, freedom. Load lang-en-about or dict-en-lite for more metalanguage.")
    ("verb" . "A verb expresses action or state — run, compute, is, become. Language packs add fuller grammar notes.")
    ("sentence" . "A sentence is a complete thought (typically subject + predicate). Ask About-facet packs for more grammar.")
    ("slang" . "Slang is informal, group-tied vocabulary. Load slang-en-lite for a dual-facet slang register on core English.")
    ("grammar" . "Grammar is the rule system for combining words into phrases and sentences. Load lang-en-about for a fuller About pack."))
