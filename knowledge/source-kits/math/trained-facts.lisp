(:FACTS
 ((METIS::SYMBOL-TRAINED "math" "1.0.0" 9 9)
  ...
  (METIS::DOMAIN-DEF "math" "additive-identity" "a + 0 = a")
  (METIS::DOMAIN-DEF "math" "multiplicative-identity" "a * 1 = a")
  (METIS::DOMAIN-DEF "math" "commutative addition" "a + b = b + a")
  (METIS::DOMAIN-DEF "math" "distributive law" "a*(b+c) = a*b + a*c")
  (METIS::DOMAIN-DEF "math" "Open educational note"
   "arithmetic foundations as taught in elementary algebra courses (OpenStax)."))
